...
import ru.otus.webserviceHW.helpers.FileSystemHelper;
import ru.otus.webserviceHW.services.TemplateProcessor;
import ru.otus.webserviceHW.servlet.UsersApiServlet;
import ru.otus.webserviceHW.servlet.UsersServlet;
...
public class UsersWebServerImpl implements UsersWebServer{
    ...
    private ServletContextHandler createServletContextHandler(){
        ...
        servletContextHandler.addServlet(new ServletHolder(new UsersServlet( dbServiceUser,templateProcessor)), "/users");
